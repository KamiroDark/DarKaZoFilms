...
public class HorarioVenom3 extends JPanel {
	...
	public HorarioVenom3() {
		...
		btnIniciarSesion.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// manera:
				Window win = SwingUtilities.windowForComponent(HorarioVenom3.this);
				if (win != null) {
		...
		btnConfirmar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				HorarioVenom3.this.setVisible(false);
